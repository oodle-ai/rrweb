(function (g, f) {
    if ("object" == typeof exports && "object" == typeof module) {
      ...
      define("rrwebReplay", [], f);
    } else if ("object" == typeof exports) {
      exports["rrwebReplay"] = f();
    } else {
      g["rrwebReplay"] = f();
    }
  }(this, () => {
...
function buildNode(n2, options) {
  ...
  switch (n2.type) {
    ...
    case NodeType$3.DocumentFragment:
...
function buildNodeWithSN(n2, options) {
  ...
  if ((n2.type === NodeType$3.Document || n2.type === NodeType$3.Element || n2.type === NodeType$3.DocumentFragment) && !skipChild) {
...
function createOrGetNode(rrNode, domMirror, rrnodeMirror) {
  ...
  switch (rrNode.RRNodeType) {
    ...
    case NodeType$1.CDATA:
      ...
      break;
    case NodeType$1.DocumentFragment:
      node2 = document.createDocumentFragment();
      break;
  }
  if (node2 && sn) domMirror.add(node2, __spreadValues({}, sn));
  if (!node2) {
    node2 = document.createDocumentFragment();
  }
  try {
