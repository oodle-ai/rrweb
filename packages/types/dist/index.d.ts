...
export declare type documentFragmentNode = {
...
export declare type serializedNode = (documentNode | documentTypeNode | elementNode | textNode | cdataNode | commentNode | documentFragmentNode) & {
    rootId?: number;
